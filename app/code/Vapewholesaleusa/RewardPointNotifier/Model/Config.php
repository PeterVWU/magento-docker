...
class Config
{
    public const XML_PATH_ENABLE = 'reward_point_notifier/general/is_enabled';
    public const XML_PATH_EMAILS_PER_DAY = 'reward_point_notifier/general/per_day';
    public const XML_PATH_EMAIL_ENABLED = 'reward_point_notifier/email/enabled';
    public const XML_PATH_EMAIL_IDENTITY = 'reward_point_notifier/email/identity';
    public const XML_PATH_EMAIL_TEMPLATE = 'reward_point_notifier/email/template';
    public const XML_PATH_EMAIL_COPY_TO = 'reward_point_notifier/email/copy_to';
    public const XML_PATH_EMAIL_COPY_METHOD = 'reward_point_notifier/email/copy_method';
