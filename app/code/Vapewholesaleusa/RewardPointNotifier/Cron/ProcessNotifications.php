...
/**
 * Cron job for processing Reward Point Notifications.
 */
class ProcessNotifications
{
     ...
     * @param \Vapewholesaleusa\RewardPointNotifier\Model\EmailSender $emailSender
    ...
    public function __construct(
        ...
        private readonly \Vapewholesaleusa\RewardPointNotifier\Model\EmailSender $emailSender,
     ...
     *
     * @param \Vapewholesaleusa\RewardPointNotifier\Api\Data\RewardPointNotificationInterface $notification
     * @return void
     */
    private function processNotification(
        \Vapewholesaleusa\RewardPointNotifier\Api\Data\RewardPointNotificationInterface $notification
    ): void {
        try {
