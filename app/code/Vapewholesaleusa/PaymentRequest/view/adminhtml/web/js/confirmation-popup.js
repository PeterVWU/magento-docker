define([
    ...
    'text!Vapewholesaleusa_PaymentRequest/template/confirmation-popup/payment-request.html'
    ...
    return Component.extend({
        ...
        initialize: function () {
             ...
             * @returns {Boolean}
             */
            window.paymentRequestConfirmationPopup = function (url) {
                confirm({
                    title: self.title,
                    content: content,
                    modalClass: 'confirm payment-request-confirm',
                    actions: {
                        /**
                         * Confirm action.
                         */
                        confirm: function () {
                            var storeId = $('#payment-request-confirmation-popup-store-id').val(),
