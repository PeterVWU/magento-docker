            ...
            if ($canEditSalesRepCommission) {
                $commissionRatesFieldset->addField(
                    ...
                    [
                        ...
                        'required' => false,
                        'note' => __('Specify salesrep commission calculation type.<br/>"Subtotal (Base Price Incl. Tax)" - will calculate commission based on base price incl. tax of order items.<br/> "Margin" - will calculate commission based on product cost.<br/>"Subtotal (Base Price)" - will calculate commission based on base price of order items.')
                    ]
                );
