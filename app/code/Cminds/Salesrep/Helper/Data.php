...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getAdmins($level = 1)
    {
        ...
        if ($level == 2) {
            $result[] = ['value' => "", 'label' => __("No Sales Rep")];
        }
...
//        $result[] = ['value' => "0", 'label' => __("No Salesrep")];
    ...
    public function getMagentoVersion()
    {
        ...
        version_compare($this->getMagentoVersion(), '2.4.6', '<') ? var_dump('less than 2.4.6') : var_dump('eq. and upper 2.4.6');
        */
        return $this->productMetadata->getVersion();  // for example return '2.4.5-p2'
    }
}
