...
return [
    'modules' => [
        ...
        'Vapewholesaleusa_AheadworksRewardPoints' => 1,
        'Vapewholesaleusa_AmastyStoreCredit' => 1,
        'Vapewholesaleusa_CmindsSalesrep' => 1,
        'Vapewholesaleusa_CustomerLicense' => 1,
        'Vapewholesaleusa_GcsRemoteStorage' => 1,
        'Vapewholesaleusa_MageWorxOrderEditor' => 1,
        'Vapewholesaleusa_OrderSource' => 1,
        'Vapewholesaleusa_PaymentRequest' => 1,
        'Vapewholesaleusa_RewardPointNotifier' => 1,
        'Vapewholesaleusa_RootwaysAuthorizecim' => 1,
        'Vapewholesaleusa_StoreCreditNotifier' => 1
    ]
];
